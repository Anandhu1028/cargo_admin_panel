...
<div class="modal fade" id="addCustomer" tabindex="-1" aria-labelledby="addCustomerLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <form action="{{ route('customers.store') }}" method="POST" class="modal-content border-0 shadow-lg rounded-4 overflow-hidden">
            @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="phone" class="form-control border-start-0" placeholder="+1 234 567 890" required>
                        </div>
                    </div>
    ...
    <!-- Save Customer Button (Dark Gradient - Original) -->
    <button type="submit"
        style="
