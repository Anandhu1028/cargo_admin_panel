                            ...
                            @foreach ($items as $row)
                              ...
                              <tr>
                                ...
                                <td class="text-end pe-3">
                                  ...
                                  @if($isCustom == 1)
                                    <button type="button" class="delete-row-btn" data-id="{{ $row['id'] }}"
                            ...
                            <tr class="d-none new-row-template" data-group="{{ $groupKey }}">
                              ...
                              <td>
                                <input type="text" name="new_unit[{{ $group }}][]"
                                  class="form-control form-control-sm short-input text-center" placeholder="Unit">
                              </td>

                              <td>
                                <input type="number" step="0.01" min="0" name="new_qty[{{ $group }}][]"
                                  class="form-control form-control-sm short-input text-end qty-input" placeholder="Qty">
                              </td>

                              <td>
                                <input type="number" step="0.01" min="0" name="new_rate[{{ $group }}][]"
                                  class="form-control form-control-sm short-input text-end rate-input" placeholder="Rate">
                              </td>

                              <td>
                                <input type="number" step="0.0001" min="0" name="new_roe[{{ $group }}][]"
                                  class="form-control form-control-sm short-input text-end" value="1">
                              </td>

                              <td class="text-center">
                                <input type="text" readonly
                                  class="form-control-plaintext text-center fw-semibold amount-display" value="0.00">
                              </td>


                              <td class="text-end pe-3">
                                <input type="text" readonly
                                  class="form-control-plaintext text-end fw-semibold total-charge-display" value="0.00">
  ...
  <script>
    ...
    document.querySelectorAll('.delete-row-btn').forEach(btn => {
      btn.addEventListener('click', function () {
        ...
        const form = document.getElementById('deleteRowFormStep3');
        form.action = `/admin/rate-calculator/step3/delete-row/${id}`;
        form.submit();
      });
    });
