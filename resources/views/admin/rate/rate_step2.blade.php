                                                ...
                                                <table class="table table-hover align-middle mb-0">
                                                    ...
                                                    <tbody class="group-body text-center" data-group="{{ $groupKey }}">
                                                        ...
                                                        @foreach ($items as $row)
                                                            ...
                                                            @if (
                                                                    ($calc->cbm <= 3 && str_contains($particular, '3 tone')) ||
                                                                    ($calc->cbm > 3 && str_contains($particular, 'van up to 3'))
                                                                )
                                                                @continue
                                                            @endif

                                                            <tr class="calc-row" data-id="{{ $row['id'] }}"
                                                                data-custom="{{ $row['is_custom'] }}" data-roe="{{ $roe }}"
                                                        ...
                                                        <tr class="new-row-template d-none calc-row" data-id="" data-custom="1">
                                                            ...
                                                            <td class="text-end">
                                                                ...
                                                                {{-- Not in DB yet — only remove from DOM via JS or form if you
                                                                want --}}
                                                                <button type="button" class="btn p-0 remove-new-row"
