...
class RateCalculatorController extends Controller
{
    ...
    public function rateStep2($calcId)
    {
        ...
        foreach ($rules as $group => $items) {
            ...
            foreach ($items as $item) {
                ...
                if (str_contains($particular, 'van up to 3') && $cbm > 3)
                    continue;
                if (str_contains($particular, '3 tone') && $cbm <= 3)
                    continue;
                ...
                if (str_contains($particular, 'packing'))
                    $qty = $cbm;
                if (str_contains($particular, 'labour'))
                    $qty = 1;
                if (str_contains($particular, 'storage'))
                    $qty = $cbm;
    ...
    public function deleteRowStep3($id)
    {
